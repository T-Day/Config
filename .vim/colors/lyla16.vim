...
hi Comment          guifg=#707070   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=Grey     ctermbg=NONE    cterm=NONE
hi Conditional      guifg=#5f5fff   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Green      ctermbg=NONE    cterm=bold
...
hi Label            guifg=#5f5fff   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Red      ctermbg=NONE    cterm=bold
...
hi Repeat           guifg=#5f5fff   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Magenta      ctermbg=NONE    cterm=bold
...
hi Statement        guifg=#008a00   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Yellow      ctermbg=NONE    cterm=bold
...
hi Structure        guifg=#536991   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Red      ctermbg=NONE    cterm=bold
...
hi Typedef          guifg=#536991   guibg=NONE      guisp=NONE      gui=bold        ctermfg=Red      ctermbg=NONE    cterm=bold
